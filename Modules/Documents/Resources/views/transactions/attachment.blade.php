    ...
    $("#attachment-form").submit(function(evt){	 
    	...
    	$.ajax({
    		...
    		success: function (response) {
    			var uploaded = `<p><a href=\"${response.fileurl}\" target=\"_blank\">${uploadedfile}</a> &nbsp;&nbsp; <a id=\"uploaded${i}\" class=\"text-danger\" onclick=\"removeAttachment(${i},\'` + response.filepath + `\'); return false;\"><i class=\"fa fa-times\" title=\"Remove\"></i></a></p>`;
    			$('#ajax-loader').hide();
