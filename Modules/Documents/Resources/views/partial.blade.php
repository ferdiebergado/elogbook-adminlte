...
<div class="flatpickr">
    ...
    <a class="btn btn-sm btn-default" title="toggle" data-toggle>
        <i class="fa fa-calendar"></i>
    </a>

    <a class="btn btn-sm btn-default" title="clear" data-clear>
        <i class="fa fa-close"></i>
														...
														<div class="form-group {{ $errors->has('received_date') ? 'has-error' : '' }}">
															...
															<div class="input-group">
																...
																<input type="text" name="received_date" class="form-control pull-right" id="received_date" value="{{ isset($document->date_received) ? $document->date_received->toDateString() : old('received_date')  }}" data-input>
															</div>
															<!-- /.input group -->
															</div>														
														...
														<div class="col-sm-6">
															{{-- <div class="bootstrap-timepicker"> --}}
																<div class="form-group {{ $errors->has('received_time') ? 'has-error' : '' }}">
																	<label>Time</label>
																	<div class="input-group timepickr">
																		<input type="text" name="received_time" class="form-control" value="{{ isset($document->date_received) ? $document->date_received->toTimeString() : old('received_time') }}" data-input>
																		<div class="input-group-addon">
