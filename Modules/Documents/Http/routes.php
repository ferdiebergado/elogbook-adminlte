...
Route::group(['middleware' => ['web', 'auth', 'user', 'prevent_back_history'], 'namespace' => 'Modules\Documents\Http\Controllers'], function () {
    ...
    Route::post('attachments/store', 'TransactionsController@storeAttachment')->name('attachments.store');
    Route::post('attachments/remove', 'TransactionsController@removeAttachment')->name('attachments.delete');
});
